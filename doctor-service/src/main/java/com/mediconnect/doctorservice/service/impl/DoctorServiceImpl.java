...
//        log.info("fetched doctor: {}", doctor);
    ...
    @Override
    @Transactional
    public ApiResponse<DoctorResponse> updateDoctor(UUID doctorId, DoctorRequest request, UUID authenticatedUserId) {
        Doctor doctor = doctorRepository.findById(doctorId)
    ...
    @Override
    @Transactional
    public ApiResponse<EducationResponse> addEducation(UUID doctorId, EducationRequest request, UUID authenticatedUserId) {
        Doctor doctor = doctorRepository.findById(doctorId)
                .orElseThrow(() -> new DoctorNotFoundException("Doctor not found with id: " + doctorId));
    ...
    @Override
    @Transactional
    public ApiResponse<ExperienceResponse> addExperience(UUID doctorId, ExperienceRequest request, UUID authenticatedUserId) {
        Doctor doctor = doctorRepository.findById(doctorId)
                .orElseThrow(() -> new DoctorNotFoundException("Doctor not found with id: " + doctorId));
